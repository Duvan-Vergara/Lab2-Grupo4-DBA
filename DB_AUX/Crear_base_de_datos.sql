...
CREATE TABLE CLIENTE (
  ...
  ubicacion_cliente GEOMETRY(POLYGON, 4326) NOT NULL
);

CREATE TABLE EMPRESA_ASOCIADA (
  id_empresa_asociada INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  nombre VARCHAR(100) NOT NULL,
  ubicacion_empresa_asociada GEOMETRY(POLYGON, 4326) NOT NULL
);
...
CREATE TABLE REPARTIDOR (
  ...
  ubicacion_repartidor GEOMETRY(POLYGON, 4326) NOT NULL,
...
CREATE TABLE PEDIDO (
  ...
  ubicacion_entrega GEOMETRY(POLYGON, 4326) NOT NULL,
  ruta_estimada GEOMETRY(POLYGON, 4326) NOT NULL,
...
CREATE TABLE EMPRESA_ZONA (
  id_empresa_zona  GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  id_empresa_asociada INT NOT NULL,
